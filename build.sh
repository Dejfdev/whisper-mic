...
echo "=== Building WhisperMic ==="

# Define target names and paths
APP_NAME="WhisperMic"
...
swift generate_icons.swift whisper .
...
<dict>
    ...
    <string>com.dawid.WhisperMic</string>
    ...
    <string>WhisperMic requires microphone access to record audio for speech-to-text dictation.</string>
